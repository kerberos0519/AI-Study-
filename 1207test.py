...
Test_English0 = {"applicant":"지원자""/""신청자", "associate":"관련시키다", "candidate":"후보자""/""지원자", "certification":"증명서","confidence": "확신""/""자신감",
                 ...
                 "make sure":"확인하다", "outstanding":"우수한", "privilege":"특권", "promptly":"즉시", "sophisticated":"정교한", "timely":"시기적절한", "violation":"위반", "rigger":"야기하다"
                 }
...
class MyWindow(QtWidgets.QWidget):
    ...
    def init_quiz(self):
        ...
        for idx, key in enumerate(words):
            ...
            self.shuffleKorWords.append(Test_English3.get(key))
